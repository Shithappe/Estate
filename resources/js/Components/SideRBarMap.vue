...
<template>
  <div class="">
    <div
      class="sm:block lg:absolute right-0 z-10 sm:w-full lg:w-1/5 h-screen shadow-lg backdrop-filter backdrop-blur-md bg-gray-400 bg-opacity-30 overflow-x-hidden sm:overflow-y-hidden lg:overflow-y-auto">
